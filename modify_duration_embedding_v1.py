...
def get_model_type_new(args):
    ...
    if args.model == "POP":
        ...
        MODEL = FPMC
    elif args.model == "LiveRec_dur_emb_v1":
        MODEL = LiveRec_dur_emb_v1
...
class LiveRec_dur_emb_v1(nn.Module):
    def __init__(self, args):
        super(LiveRec_dur_emb_v1, self).__init__()
        self.args = args
...
#         i_embs = 0
        ...
        return (feats * i_embs).sum(dim=-1) #dot product to get final score
