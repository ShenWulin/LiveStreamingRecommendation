...
def get_model_type(args):
    ...
    if args.model == "POP":
        ...
        MODEL = FPMC
    elif args.model == "LiveRec_dur_gru":
        MODEL = LiveRec_dur_gru
...
class LiveRec_dur_gru(nn.Module):
    def __init__(self, args):
        super(LiveRec_dur_gru, self).__init__()
        self.args = args
...
#         self.lstm = nn.LSTM(args.K * 2, args.K, batch_first=True, bidirectional=False)
        self.gru = nn.GRU(args.K * 2, args.K, batch_first=True, bidirectional=False)
