...
def arg_parse():
        ...
        parser.set_defaults(
                        seed=42,
                        dataset="C:/Users/dell/Desktop/recommendation systems/",
                        lr=0.0005,
                        l2=0.1,  
                        mask_prob=0.5,  
                        batch_size=100, 
                        ...
                        model="LiveRec",
#                         model="POP",
                        model_path="C:/Users/dell/Desktop/recommendation systems/liverec-main/models",
                        mto="liverec",
                        device="cuda",
                        cache_dir="C:/Users/dell/Desktop/recommendation systems/liverec-main/dataset/"
                       )
